...
static int compute_pairs(const int *const, const int, const int);
...
static int compute_pairs(const int *const data, const int n, const int k) {
    int tot_pairs = 0;
