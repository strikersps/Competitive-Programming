/*
 * Problem Statement: https://www.hackerrank.com/test/33gp893pqhs/questions/bdfkfnld4gp
 * Author: striker
 *
...
static std :: string password_decryptor(const std :: string &);

int main(void) {
    FAST_IO(0);
    std :: string encrypted_string;
    std :: cin >> encrypted_string;
    std :: cout << password_decryptor(encrypted_string) << NEW_LINE;
    return 0;
}

static std :: string password_decryptor(const std :: string & encrypted_string) {
