...
int main(void) {
    ...
    while(test--) {
        ...
        int team_a[n], team_b[n];
        int max_team_a, max_team_b;
        max_team_a = max_team_b = 0;
        for(register int i = 0; i < n; ++i) {
            if(1 == scanf("%d", team_a + i)) {
                if(team_a[i] > max_team_a) {
                    max_team_a = team_a[i];
                }
                continue;
            }
        ...
        for(register int i = 0; i < n; ++i) {
            if(1 == scanf("%d", team_b + i)) {
                if(team_b[i] > max_team_b) {
                    max_team_b = team_b[i];
                }
                continue;
            }
