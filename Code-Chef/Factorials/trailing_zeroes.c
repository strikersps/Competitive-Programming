...
static ll_t compute_trailing_zeroes(const ll_t);
...
static ll_t compute_trailing_zeroes(const ll_t n) {
    ll_t count_trailing_zeroes = 0;
    for(register ll_t i = 5; (n / i) >= 1; count_trailing_zeroes += (n / i), i *= 5);
