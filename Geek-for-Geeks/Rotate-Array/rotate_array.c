...
static void display_list(int[], const int, const char*);

int main(void) {
    /* Geek-for-Geeks doesn't have ONLINE_JUDGE macro defined.
    #ifndef ONLINE_JUDGE
...
static void display_list(int data[], const int n, const char *delimiter) {
    printf("%d", data[0]);
