...
static int compute_number_of_steps(int);
...
// Function needs to be written on Leet-Code as follows:
static int compute_number_of_steps(int n) {
    return log2(n) + COMPUTE_SET_BITS(n);
}
